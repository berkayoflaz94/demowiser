...
export default function Page() {
    ...
    const saveCompany = () => {
        ...
        if (params._id) {
            apiPostUpdateCompanies(params).then(() => {
                setRowDataUpdate(rowDataUpdate + 1);
            });
        } else {
            apiPostSaveCompanies(params).then(() => {
                setRowDataUpdate(rowDataUpdate + 1);
            });
        }
    ...
    const deleteNote = () => {
        apiPostDeleteCompanies(deletedNote).then(() => {
            setRowDataUpdate(rowDataUpdate + 1);
        });
        ...
        <>
            <div className="panel">
                <div className="mb-5 flex items-center justify-between">
                    <h5 className="text-lg font-semibold dark:text-white-light">List Companies</h5>
                                ...
                                >
                                    <Dialog.Panel className="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        ...
                                        <div className="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-4 rtl:pr-4 dark:bg-[#121c2c]">
                                            {params._id ? 'Edit Company' : 'Add Company'}
                                        </div>
                                        <div className="p-5">
                                            <div className="mb-5">
